# CLAUDE.md — SARAJOO 브랜드 사이트 AI 에이전트 행동 규칙

## 프로젝트 개요
- **프로젝트:** SARAJOO 까멜리아 도자기 괄사 브랜드 사이트
- **기술 스택:** Next.js 14 (App Router) + Tailwind CSS + Framer Motion + Vercel
- **기획 문서:** `doc/브랜드사이트_구축계획서_v4.0.md`
...
7. **메모리관리:** 컨텍스트 기억을 위해 지속적으로 memory.md 업데이트

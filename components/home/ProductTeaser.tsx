  ...
  return (
    <AnimatedSection>
      <div className="grid grid-cols-1 md:grid-cols-[3fr_2fr] gap-8 md:gap-16">
        ...
        >
          <ImageSlider
            images={["/images/product/mood-fabric.jpg", "/images/product/mood-interior.jpg", "/images/product/mood-spa.jpg", "/images/product/mood-stone.jpg"]}
            alt="SARAJOO 제품"
        ...
        <div className="md:mt-16">
          ...
          <p className="font-sans text-brand-body leading-body-kr mt-6 md:mt-8">
            ...
            높은 소성 온도가 만들어낸 치밀한 조직 덕분에 냉기와 온기를 15분 이상 유지하며,
          ...
          <ul className="mt-6 space-y-2">
            <li className="flex items-start gap-2 font-sans text-sm text-brand-body">
              ...
              <span>15분 이상 온도 유지<br className="md:hidden" />— 전자레인지 15초면 준비 완료</span>
            </li>
            <li className="flex items-start gap-2 font-sans text-sm text-brand-body">
              <span className="w-1 h-1 rounded-full bg-brand-gold mt-2 flex-shrink-0" />
